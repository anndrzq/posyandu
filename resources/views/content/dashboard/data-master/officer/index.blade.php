                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <dl class="row">
                                <dt class="col-sm-4">Nomor Induk Keluarga</dt>
                                <dd class="col-sm-8">:{{ $officer->nik ?? 'N/A' }}</dd>

                                <dt class="col-sm-4">Nomor Induk Pokok</dt>
                                <dd class="col-sm-8">:{{ $officer->nip ?? 'N/A' }}</dd>

                                <dt class="col-sm-4">Nama Petugas</dt>
                                <dd class="col-sm-8">:{{ $officer->name ?? 'N/A' }}</dd>

                                <dt class="col-sm-4">Tempat Lahir</dt>
                                <dd class="col-sm-8">:{{ $officer->place_of_birth ?? 'N/A' }}</dd>
                                ...
                                <dd class="col-sm-8">:{{ $officer->gender ?? 'N/A' }}</dd>

                                <dt class="col-sm-4">Alamat</dt>
                                <dd class="col-sm-8">:{{ $officer->address ?? 'N/A' }}</dd>

                                <dt class="col-sm-4">Jabatan</dt>
                                <dd class="col-sm-8">:{{ $officer->position ?? 'N/A' }}</dd>

                                <dt class="col-sm-4">Pendidikan Terakhir</dt>
                                <dd class="col-sm-8">:{{ $officer->last_educations ?? 'N/A' }}</dd>

                                <dt class="col-sm-4">Nomor Telefon</dt>
                                <dd class="col-sm-8">:{{ $officer->phone_number ?? 'N/A' }}</dd>
                            </dl>
                        </div>
                    </div>
